...
use BlackCat\Database\Packages\SessionAudit\Repository\SessionAuditRepositoryInterface;
use BlackCat\Database\Packages\SessionAudit\Repository\SessionAuditRepository as GeneratedRepository;
...
{
  private SessionAuditRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof SessionAuditRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected SessionAuditRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\SessionAudit\Dto\SessionAuditDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\SessionAudit\Dto\SessionAuditDto|null { return $this->repo->getById($id, $asDto); }
