...
{
    private SessionAuditRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new SessionAuditRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\SessionAudit\Dto\SessionAuditDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\SessionAudit\Dto\SessionAuditDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\SessionAudit\Dto\SessionAuditDto|null
    {
