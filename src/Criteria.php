...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'session_token_hash', 'session_token_key_version', 'csrf_token_hash', 'csrf_key_version', 'session_id', 'event', 'user_id', 'ip_hash', 'ip_hash_key_version', 'user_agent', 'meta_json', 'outcome', 'created_at' ];
    }
    ...
    {
        $x = [ 'id', 'session_token_key_version', 'csrf_key_version', 'session_id', 'event', 'user_id', 'ip_hash_key_version', 'user_agent', 'outcome', 'created_at' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\SessionAudit\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\SessionAudit\Definitions::softDeleteColumn();
