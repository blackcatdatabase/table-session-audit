 ...
 * - whitelist filtrů: [ 'id', 'session_token', 'session_token_key_version', 'csrf_key_version', 'session_id', 'event', 'user_id', 'ip_hash', 'ip_hash_key_version', 'user_agent', 'meta_json', 'outcome', 'created_at' ]
 * - whitelist pro LIKE hledání: [ 'session_token_key_version', 'csrf_key_version', 'session_id', 'event', 'ip_hash_key_version', 'user_agent', 'outcome' ]
 */
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        // filtry (rovnosti / IN)
        $allowed = array_fill_keys([ 'id', 'session_token', 'session_token_key_version', 'csrf_key_version', 'session_id', 'event', 'user_id', 'ip_hash', 'ip_hash_key_version', 'user_agent', 'meta_json', 'outcome', 'created_at' ], true);
        ...
        if ($this->search !== null) {
            $searchCols = [ 'session_token_key_version', 'csrf_key_version', 'session_id', 'event', 'ip_hash_key_version', 'user_agent', 'outcome' ];
            $likeParts = [];
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'session_token', 'session_token_key_version', 'csrf_key_version', 'session_id', 'event', 'user_id', 'ip_hash', 'ip_hash_key_version', 'user_agent', 'meta_json', 'outcome', 'created_at' ], true);
            $parts = [];
