...
final class SessionAuditDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'session_token' => 'sessionToken', 'session_token_key_version' => 'sessionTokenKeyVersion', 'csrf_key_version' => 'csrfKeyVersion', 'session_id' => 'sessionId', 'user_id' => 'userId', 'ip_hash' => 'ipHash', 'ip_hash_key_version' => 'ipHashKeyVersion', 'user_agent' => 'userAgent', 'meta_json' => 'metaJson', 'created_at' => 'createdAt' ];
    /** @var string[] */
    ...
    /** @var string[] */
    private const BIN_COLS    = [ 'session_token', 'ip_hash' ];
    /** @var string[] */
    private const NULLABLE    = [ 'id', 'session_token', 'session_token_key_version', 'csrf_key_version', 'session_id', 'user_id', 'ip_hash', 'ip_hash_key_version', 'user_agent', 'meta_json', 'outcome' ];
    ...
    public static function fromRow(array $row): SessionAuditDto {
        ...
        return new SessionAuditDto(...$vals);
    }
