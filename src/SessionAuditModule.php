...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'gin_session_audit_meta', 'idx_session_audit_created_at', 'idx_session_audit_event', 'idx_session_audit_event_time', 'idx_session_audit_event_user_time', 'idx_session_audit_ip_hash', 'idx_session_audit_session_id', 'idx_session_audit_token_hash', 'idx_session_audit_token_time', 'idx_session_audit_user_event_time', 'idx_session_audit_user_id' ];
        if ($d->isMysql()) {
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'gin_session_audit_meta', 'idx_session_audit_created_at', 'idx_session_audit_event', 'idx_session_audit_event_time', 'idx_session_audit_event_user_time', 'idx_session_audit_ip_hash', 'idx_session_audit_session_id', 'idx_session_audit_token_hash', 'idx_session_audit_token_time', 'idx_session_audit_user_event_time', 'idx_session_audit_user_id' ],
