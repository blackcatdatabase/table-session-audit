...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'session_token_hash', 'session_token_key_version', 'csrf_token_hash', 'csrf_key_version', 'session_id', 'event', 'user_id', 'ip_hash', 'ip_hash_key_version', 'user_agent', 'meta_json', 'outcome', 'created_at' ]; }
