...
- Pkg folder: [packages\session-audit](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\session-audit)
...
graph LR
  ...
  session_audit["session_audit"]:::center
  session_audit -->|FK| users["users"]:::link
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package session-audit -Apply
